    ...
    <nav className="sticky top-0 z-50 bg-white border-b border-brand-border shadow-sm">
      <div className="max-w-6xl mx-auto px-4 h-14 flex items-center justify-between">
        ...
        <a
          ...
          className="hidden md:flex items-center gap-1.5 bg-[#25D366] text-white text-sm font-semibold px-3 py-1.5 rounded-full"
        >
      ...
      {open && (
        <div className="md:hidden bg-white border-t border-brand-border px-4 py-4 space-y-3">
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="flex items-center gap-2 bg-[#25D366] text-white font-semibold px-4 py-2.5 rounded-full w-fit"
