const reasons = [
  ...
  },
  {
    ...
    title: 'All Under ₹200',
    desc: 'Trendy, useful products for your family — all priced under ₹200. Best value guaranteed.',
  },
  {
    icon: (
      <svg className="w-7 h-7" fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24">
  ...
  },
  {
    ...
    desc: 'Have a question? Chat with us directly on WhatsApp. We reply within minutes.',
  },
]
