        ...
        <div className="flex flex-col md:flex-row gap-6 md:gap-10">
          ...
          <div className="w-full md:w-1/2 flex flex-col gap-4">
            ...
            <a
              ...
              className="flex items-center justify-center gap-2.5 w-full border-2 border-brand-green text-brand-green font-semibold text-sm py-3 rounded-xl hover:bg-green-50 active:scale-95 transition-all"
            >
              <svg className="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
              </svg>
              Call to Order — +91 99401 03738
            </a>
          </div>
        </div>
